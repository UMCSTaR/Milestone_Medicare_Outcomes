...
plot(ggpredict(model_severe_cmp, terms = predict_term))


ggpredict(model_severe_cmp, terms = paste(predict_term, "[quart2]")) %>% 
...
# predicted probability for surgeons
plot(ggpredict(model_any_cmp, terms = predict_term))

ggpredict(model_any_cmp, terms = paste(predict_term, "[quart2]")) %>%
  mutate(quart = c( "Q1", "median", "Q3")) %>%
  rename(milestone_rating = x) %>%
  select(quart, everything(), -group) %>%
  kable_df()
...
# predicted probability for surgeons
plot(ggpredict(flg_readmit_30d, terms = predict_term))

ggpredict(flg_readmit_30d, terms = paste(predict_term, "[quart2]")) %>%
  mutate(quart = c( "Q1", "median", "Q3")) %>%
  rename(milestone_rating = x) %>%
  select(quart, everything(), -group) %>%
  kable_df()
...
# predicted probability for surgeons
plot(ggpredict(flg_death_30d, terms = predict_term))

ggpredict(flg_death_30d, terms = paste(predict_term, "[quart2]")) %>%
  mutate(quart = c( "Q1", "median", "Q3")) %>%
  rename(milestone_rating = x) %>%
  select(quart, everything(), -group) %>%
  kable_df()
...
# predicted probability for surgeons
plot(ggpredict(flg_util_reop, terms = predict_term))

ggpredict(flg_util_reop, terms = paste(predict_term, "[quart2]")) %>%
  mutate(quart = c( "Q1", "median", "Q3")) %>%
  rename(milestone_rating = x) %>%
  select(quart, everything(), -group) %>%
  kable_df()
...
# predicted probability for surgeons
plot(ggpredict(flg_any_but_death, terms = predict_term))

ggpredict(flg_any_but_death, terms = paste(predict_term, "[quart2]")) %>%
  mutate(quart = c( "Q1", "median", "Q3")) %>%
  rename(milestone_rating = x) %>%
  select(quart, everything(), -group) %>%
  kable_df()
