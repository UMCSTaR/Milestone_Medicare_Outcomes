...
This document uses the end-year milestone evaluations at the last year of residency from ACGME. Milestone rating for each resident is the mean of all questions. We used Partial Colectomy procedure as our cohort.


```{r milestone eval, eval=F}
...
milestone_medicare_pc %>%
  select(flg_male, age_at_admit, e_race_wbho_lable, AHRQ_score, ses_2grp,
colectomy_type, facility_clm_yr, flg_multi_surgeon, flg_assistant_surgeon, hosp_beds_2grp, val_hosp_mcday2inptday_ratio, val_hosp_rn2bed_ratio) %>%
