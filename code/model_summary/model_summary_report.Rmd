...
## Outcomes: Severe Complication (Excluded POA)

### 1.1 Overall Mean

```{r overall_mean}
overall_mean = results$Par_severe_cmp_all_mean
...
```{r mean_lt8}
mean_ge_8 = results$Par_severe_cmp_mean_ge_8
...
```{r ever_lt8}
never_lt_8 = results$Par_severe_cmp_never_less_8
...
```{r prof_mean}
prof_mean = results$Par_severe_cmp_prof
...
```{r prof_8}
prof_ge_8 = results$Par_severe_cmp_prof_ge8
...
```{r opera_mean}
operative_mean = results$Par_severe_cmp_operative
...
```{r opera_8}
operative_ge8 = results$Par_severe_cmp_operative_ge8
...
```{r lead_mean}
lead_mean = results$Par_severe_cmp_leadership
...
```{r lead_lt8}
lead_ge8 = results$Par_severe_cmp_leadership_ge8
