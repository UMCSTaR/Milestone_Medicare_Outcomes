...
ggplot(data = p$data %>%
       ...
       aes(
         x = factor(mean_ge_8, labels = c("Overall rating <8", "Overall rating ≥8")),
         y = yvar,
  ...
  labs(y = "Estimated probabilities of severe complications",
       caption = "The interaction effect of overall Milestone ratings with vs. without assistant surgeons",
       color = "") +
...
ggsave("images/interaction_assist_surg_overall_rating.png")
